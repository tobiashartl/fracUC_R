...
gr.start <- expand.grid(r.grid, corr_grid, ar.1.grid, ar2.grid) %>% as.matrix()
...
for ( i in 1:NROW(setups)){
    ...
    save(RESULTS, file = paste("./MC/Integer/Sim_R", R, "_n", n, "_d", d, "_nu", nu, "_ar_high_corr.RData", sep=""))
}
